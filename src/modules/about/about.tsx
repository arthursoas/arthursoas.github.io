      ...
      <Container>
        ...
        <Row className="mb3 flex items-center">
          ...
          <Col lg className="flex flex-column">
            ...
            <p className="mb0">Principal toolkit frontend. Utilizado através da biblioteca react-bootstrap.</p>
          </Col>
        </Row>
        <Row className="mb3 flex items-center">
          <Col lg="1">
          ...
          <Col lg className="flex flex-column">
            ...
            <p className="mb0">Toolkit CSS que diminui a quantidade de CSS necessário no código.</p>
          </Col>
        </Row>
      </Container>
    );
